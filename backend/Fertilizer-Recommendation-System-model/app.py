...
def total_yield():
    ...
    {
      "area_acres": 3.0,
      "fertilizer_per_acre": 50.0   # optional; if omitted we use last saved prediction
    }
    Response:
    {
      "area_acres": 3.0,
      "fertilizer_per_acre": 50.0,
      "total_fertilizer_per_acre_kg": 150.0,
    ...
    if "fertilizer_per_acre" in body and body["fertilizer_per_acre"] is not None:
        ...
        if not last or "fertilizer_per_acre" not in last:
            return jsonify({"error": "No last prediction found. Call /predict first or provide fertilizer_per_acre."}), 400
