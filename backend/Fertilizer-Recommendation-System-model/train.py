...
#
# ✅ FIX ADDED (your issue):
# If a categorical feature (ex: Crop) maps 1-to-1 to Fertilizer_Type in the dataset,
# the model will get 100% accuracy (data leakage/shortcut).
# This code automatically detects such "deterministic" categorical features and removes them
# ONLY for classification, so your accuracy becomes realistic.
# =========================
...
def find_columns(df: pd.DataFrame) -> Dict[str, str]:
    ...
    synonyms = {
        ...
        "yield": ["yield", "yield_kg_per_acre", "yield_kg_acre", "yield_kg_ac", "yield_kg",
                  "yield_kg_per_hectare", "yield_t_ha", "yield_kg_ha", "fertilizer_per_acre"],
    }
...
# =========================
# ✅ FIX: detect leakage shortcut columns
# =========================
...
def main():
    ...
    parser.add_argument("--input", type=str, default="fertilizer_recommendation_dataset.csv",
